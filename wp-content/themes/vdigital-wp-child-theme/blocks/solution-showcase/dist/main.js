...
/***/ "./wp-content/themes/vdigital-wp-child-theme/resources/js/helpers/SliderUtils.js"
/*!***************************************************************************************!*\
  !*** ./wp-content/themes/vdigital-wp-child-theme/resources/js/helpers/SliderUtils.js ***!
  \***************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   disableSliderLinks: () => (/* binding */ disableSliderLinks),
/* harmony export */   updateDots: () => (/* binding */ updateDots)
/* harmony export */ });
/**
 ...
 */
function updateDots(container, currentIndex, slider) {
  var dots = container.querySelectorAll(".dots .dot");
  var info = slider.getInfo();
  var totalSlides = info.slideCount;
  var itemsVisible = info.items;
  var slideBy = info.slideBy;
  var dotsCount = itemsVisible >= totalSlides ? 0 : Math.ceil((totalSlides - itemsVisible) / slideBy) + 1;
  dots.forEach(function (dot, dotIndex) {
    dot.classList.remove("fade-out", "fade-in", "active");
    if (dotIndex < dotsCount) {
      dot.classList.add("fade-in");
      var activePosition = Math.floor(currentIndex / slideBy);
 ...
 */
function disableSliderLinks(containerSelector, linkSelector) {
  var attempts = 0;
  var maxAttempts = 5;
  var interval = setInterval(function () {
    var sliderContainers = document.querySelectorAll(containerSelector);
    if (sliderContainers.length > 0) {
      sliderContainers.forEach(function (container) {
        var links = container.querySelectorAll(linkSelector);
...
(() => {
/*!***********************************************************************************************!*\
  !*** ./wp-content/themes/vdigital-wp-child-theme/blocks/solution-showcase/javascript/main.js ***!
  \***********************************************************************************************/
__webpack_require__.r(__webpack_exports__);
...
/* harmony import */ var _resources_js_helpers_SliderUtils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../resources/js/helpers/SliderUtils */ "./wp-content/themes/vdigital-wp-child-theme/resources/js/helpers/SliderUtils.js");
/**
...
function destroySliders() {
  ...
  Object.keys(showcaseSliders).forEach(function (key) {
    if (showcaseSliders[key] && typeof showcaseSliders[key].destroy === "function") {
...
function initializeSliders() {
  ...
  if (document.body.classList.contains("block-editor-page") && document.body.classList.contains("wp-admin") || document.body.classList.contains("block-editor-iframe__body")) {
    (0,_resources_js_helpers_SliderUtils__WEBPACK_IMPORTED_MODULE_1__.disableSliderLinks)(".solution-showcase", ".solution-showcase__tile");
    return;
  }
  ...
  if (window.innerWidth >= 1280) {
    ...
    var navContainers = document.querySelectorAll(".solution-showcase__navigation");
    navContainers.forEach(function (nav) {
      nav.style.display = "none";
    });
    return;
  }
  var sliderContainers = document.querySelectorAll(".solution-showcase");
  sliderContainers.forEach(function (container, index) {
    if (!container) return;
    var showcases = container.querySelectorAll(".solution-showcase__showcase");
    showcases.forEach(function (showcase, showcaseIndex) {
      var sliderContainer = showcase.querySelector(".solution-showcase__tiles");
      if (!sliderContainer) return;
      var navContainer = showcase.querySelector(".solution-showcase__navigation .dots");
      var items = sliderContainer.querySelectorAll(".wrapper");
      if (items.length <= 1) {
        if (navContainer) navContainer.style.display = "none";
        return;
      }
      var sliderIndex = "".concat(index, "_").concat(showcaseIndex);
      ...
      showcaseSliders[sliderIndex] = (0,_node_modules_tiny_slider_src_tiny_slider__WEBPACK_IMPORTED_MODULE_0__.tns)({
      ...
      (0,_resources_js_helpers_SliderUtils__WEBPACK_IMPORTED_MODULE_1__.updateDots)(showcase, 0, showcaseSliders[sliderIndex]);
      showcaseSliders[sliderIndex].events.on("newBreakpointEnd", function (info) {
        (0,_resources_js_helpers_SliderUtils__WEBPACK_IMPORTED_MODULE_1__.updateDots)(showcase, info.index, showcaseSliders[sliderIndex]);
      });
      showcaseSliders[sliderIndex].events.on("indexChanged", function (info) {
        (0,_resources_js_helpers_SliderUtils__WEBPACK_IMPORTED_MODULE_1__.updateDots)(showcase, info.index, showcaseSliders[sliderIndex]);
      });
    });
  });
...
function alignTitles() {
  var showcases = document.querySelectorAll(".solution-showcase__showcase");
  showcases.forEach(function (showcase) {
    var titles = showcase.querySelectorAll(".solution-showcase__tile-title");
...
function setupToggle(block) {
  var toggleBtn = block.querySelector(".solution-showcase__toggle-btn");
  var sectorShowcase = block.querySelector(".solution-showcase__showcase--sector");
  var roleShowcase = block.querySelector(".solution-showcase__showcase--role");
  if (!toggleBtn || !sectorShowcase || !roleShowcase) {
    return;
  }

  // Set initial state
  var currentShowcase = "sector";
  ...
  toggleBtn.addEventListener("click", function () {
    if (currentShowcase === "sector") {
      ...
      toggleBtn.textContent = toggleBtn.getAttribute("data-sector-text") || "Show by sector";
      ...
      toggleBtn.textContent = toggleBtn.getAttribute("data-role-text") || "Show by role";
...
if (window.acf) {
  ...
  window.acf.addAction("render_block_preview/type=solution-showcase", function ($el) {
    var block = $el[0].querySelector(".solution-showcase");
    if (block) {
      setupToggle(block);
      alignTitles();
    }
