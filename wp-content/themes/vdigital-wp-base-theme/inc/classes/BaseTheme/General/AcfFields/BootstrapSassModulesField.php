...
HTML;
			...
			$bootstrapModules = $baseTheme->Frontend->Assets->getCurrentBootstrapSassModules();
			$mandatoryModules = $baseTheme->Frontend->Assets->getMandatoryBootstrapSassModules();
...
HTML;
		...
		public function update_value( $value, $post_id, array $field ) {
			...
			// Store the Sass Modules
			baseTheme()->Frontend->Assets->storeCurrentBootstrapSassModules( $value );
